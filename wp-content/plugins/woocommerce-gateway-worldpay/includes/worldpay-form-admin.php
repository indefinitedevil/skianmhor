...
/*				'sslurls' 				=> array(
												'title' 		=> __( 'URL Format', 'woocommerce_worlday' ),
												'type' 			=> 'select',
												'options' 		=> array('http'=>'Use HTTP URLs','https'=>'Use HTTPS URLs'),
												'description' 	=> __( 'Included in the information sent to WorlPay are URLs. If your site uses HTTPS and an SSL certificate with SNI then these URLs might fail. If they do then you can set this option to HTTP.', 'woocommerce_worlday' ),
												'default' 		=> $this->default_authMode
												),
*/				'accid' 				=> array(
