		...
		public function admin_options() {
			...
			<?php if ( (!$this->instId || $this->instId== '' || !$this->callbackPW || $this->callbackPW == '' ) && current_user_can( 'manage_options' ) ) { ?>
				...
				<div id="wc_gateway_worldpay_form">
					<p><?php _e('Please complete the settings below, as minimum you need to enter the Installation ID, given to you by WorldPay, and create a Callback Password. 
					Using an MD5 password is also recommended', 'woocommerce_worlday'); ?></p>
					...
					<p><?php _e('Please refer to the <a href="http://docs.woothemes.com/document/worldpay/" target="_blank">WooCommerce WorldPay docs</a> 
			   		for more information and a short video', 'woocommerce_worlday'); ?></p>
				</div>
