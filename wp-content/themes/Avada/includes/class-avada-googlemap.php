...
class Avada_GoogleMap {
	...
	function render( $args, $content = '' ) {
		...
		if ( $address ) {
            ...
            //wp_print_scripts( 'google-maps-fusion' );

			ob_start(); ?>
			<script type="text/javascript">
                function initMap() {
                    var skianmhor = {lat:55.5223113, lng:-4.0654777};
                    ...
                    var info = new google.maps.InfoWindow({
                        position: skianmhor,
                        content: '<div id="content" style="color:#222;font-size:1.2em;">' +
            ...
            <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC9T9XQgPq2mKksW0zY5mJ8ZvMsHLv_NfQ&callback=initMap&sensor=false" type="text/javascript"></script>
			<?php
